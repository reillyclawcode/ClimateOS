          ...
          <section>
            ...
            <div className="glass-card p-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <a href="https://simulation-tau-dun.vercel.app/" target="_blank" rel="noopener" className="flex items-center gap-3 rounded-xl border border-sky-500/20 bg-sky-500/5 p-4 transition hover:bg-sky-500/10">
                ...
                <a href="https://transition-os-beta.vercel.app/" target="_blank" rel="noopener" className="flex items-center gap-3 rounded-xl border border-emerald-500/20 bg-emerald-500/5 p-4 transition hover:bg-emerald-500/10">
                ...
                <a href="https://civilization-os-3nlf.vercel.app/" target="_blank" rel="noopener" className="flex items-center gap-3 rounded-xl border border-amber-500/20 bg-amber-500/5 p-4 transition hover:bg-amber-500/10">
                ...
                <a href="https://civilization-os-ashy.vercel.app/" target="_blank" rel="noopener" className="flex items-center gap-3 rounded-xl border border-violet-500/20 bg-violet-500/5 p-4 transition hover:bg-violet-500/10">
